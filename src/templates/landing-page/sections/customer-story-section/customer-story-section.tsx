  ...
  return (
    <section className="container py-8 md:py-10">
      <div className="flex flex-col items-center gap-12">
        <h2 className='font-sans text-gray-100 text-heading-xl'>Quem utiliza, aprova!</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {customerStories.map((customerStory) => (
            <div key={customerStory.author.name} className="flex flex-col gap-6 rounded-lg bg-gray-500 p-6 md:p-12">
              <p className="text-balance text-gray-200 text-body-md italic font-inter">{customerStory.content}</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <strong className="text-gray-200 text-sm font-inter">{customerStory.author.name}</strong>
                  <span className="text-gray-300 text-xs font-inter">{customerStory.author.role}</span>
                </div>
              </div>
            </div>
          ))}
