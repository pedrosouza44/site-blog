  ...
  return (
    <section className="container relative flex items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 mg:items-start lg:items-start">
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-200 text-body-md font-inter">Crie o seu site em menos de 5 minutos</span>
              </div>

              <div className="flex items-center gap-2">
                <Store className="text-cyan-100 h-4 w-4" />
                <span className="text-gray-200 text-body-md font-inter">Acompanhe e otimize seu negócio online</span>
              </div>
            </div>

            <div className="text-white flex flex-col gap-2 mt-5 items-center md:items-start lg:items-start">
              <Button className="rounded-full w-fit font-inter" asChild>
              ...
              <p className="text-gray-300 text-body-xs font-inter">Não precisa de cartão de crédito</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center justify-center md:flex lg:flex">
          <Image
            ...
            alt="Ilustração com ícone de store, tag e sacola"
            width={200}
            height={400}
