...
export const CallToAction = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-cyan-950/20 to-gray-700">
      ...
      <div className="absolute p-4 bg-cyan-300 w-fit rounded-full top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="container relative">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <Button variant='primary' asChild className="mt-6 font-inter">
